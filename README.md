...
Spatial autocorrelation is a spatial analysis technique that determines whether an observation is positively or negatively correlated with its surroundings. This reveals patterns of distribution, whether random, clustered, or dispersed in a particular area. Global Moran's I measures these spatial association simultaneously, based on location and value, providing a generalized inferential statistic (ESRI, 2024). Local Moran's I or LISA, compares all values and locations within the context of all neighbouring values, providing a comprehensive statistic describing 'hotspots' and outliers.(ESRI, 2024). In each of these tests we will examine how similar or dissimilar observations at a location (i) are from observations at neighbouring locations (j). This method of spatial analysis is a functional application of Toblers Law, which states that observations are not independant and will be influenced by observations at nearby locations (Miller H.J., 2004).
